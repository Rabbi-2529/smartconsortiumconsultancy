...
<!-- Mirrored from devsaidul.com/html3/new/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 03:57:06 GMT -->
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>IGL Web Ltd.</title>
          ...
          <div class="row">
            <div class="col-12">
              <div class="d-flex justify-content-between align-items-center text-light">
                <a href="mailto:support@iglweb.com">support@iglweb.com
            ...
            <div class="container">
              ...
              <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample"
                ...
                <div class="offcanvas-body">
                  <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item ">
                      <a class="nav-link " href="index.html" data-bs-toggle="dropdown" aria-expanded="false">
                        Home
                      </a>
              ...
              Products And Services
                ...
                <!--<p class="description">-->
                <!--  <a href="index.html">Home</a> <i class="fa-solid fa-chevron-right"></i> <span>Blog Grid</span>-->
                <!--</p>-->
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="section-title">
              <h1 class="title skew-up">Products and Services</h1>
            </div>
          </div>
          <div class="col-12 col-lg-4">
            <div class="latest-news-grid-item card-box zoom-effect">
              <div class="img">
                <a href="#">
                  <img class="product-div-images" src="assets/images/products/policies.jpg" alt="">
                </a>
              </div>
              <div class="content">
                <a href="#" class="d-block">
                  <h1 class="w-100">Documentation and Policy Development</h1>
                  <p class="mb-3">Policy development and help for the Strategic Decision Making. We give the solution and develop the required formats and reports for Human Resources, Administration and Compliance departments’ all necessary requirements and place the same with the systematic approach to make it a success. </p>
                </a>
                <a href="#">read more
                  <span>
          ...
          <div class="col-12 col-lg-4">
            <div class="latest-news-grid-item card-box zoom-effect">
              <div class="img">
                <a href="#">
                  <img class="product-div-images" src="assets/images/products/manpower.png" alt="">
                </a>
              </div>
              <div class="content">
                <a href="#" class="d-block">
                  <h1 class="w-100">Structuring & Restructuring of the Manpower</h1>
                  <p class="mb-3">We do the analysis of H.R, Admin and Compliance Department’s Officers’ job with specific Job Description for the 100% employee engagement. We do the analysis of H.R, Admin and Compliance Department’s Officers’ job with specific Job Description for the 100% employee engagement.</p>
                </a>
                <a href="#">read more
                  <span>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="col-12 col-lg-4">
            <div class="latest-news-grid-item card-box zoom-effect">
              ...
              <div class="content">
                <a href="#" class="d-block">
                  <h1 class="w-100">Job Placement for the Officers</h1>
                  <p class="mb-3">The competent Officers, Managers and Senior Positional employee as suitable for the customer for H.R, Administration and Compliance department in the RMG industry or for other manufacturing industries from our wide range of references of the different associations.</p>
                </a>
                <a href="#">read more
                  <span>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-lg-6">
                <p>Copyright © <a href="https://iglweb.com/web/" style="color: greenyellow; z-index: 9999;">IGL WEB Ltd.</a>  All Rights Reserved.</p>
            </div>
            <div class="col-12 col-lg-6">
              <ul>
                <li>
...
<!-- Mirrored from devsaidul.com/html3/new/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 03:57:07 GMT -->
</html>