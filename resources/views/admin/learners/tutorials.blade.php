...
<div class="container mt-5">
    <h1>Tutorials for {{ $learner->first_name }} {{ $learner->last_name }}</h1>
    ...
    @if($tutorials->isEmpty())
        <p>No tutorials available for the courses you are enrolled in.</p>
    @else
        <div class="row">
            @foreach($tutorials->groupBy('course_id') as $courseId => $tutorialGroup)
                @php
                        ...
                        <div class="card shadow-sm border-light">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="{{ route('tutorials.show', ['course_id' => $course->id]) }}" class="btn btn-primary">View Tutorials</a>
