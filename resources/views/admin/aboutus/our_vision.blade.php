...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('our_vision.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="card-body">
                    <textarea id="ckeditor-classic" name="our_vision" id="" cols="30" rows="10">{{ old('our_vision', $aboutUs->our_vision ?? '') }}</textarea>
