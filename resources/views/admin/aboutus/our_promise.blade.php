...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('our_promise.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="card-body">
                    <textarea id="ckeditor-classic" name="our_promise" id="" cols="30" rows="10">{{ old('our_promise', $aboutUs->our_promise ?? '') }}</textarea>
