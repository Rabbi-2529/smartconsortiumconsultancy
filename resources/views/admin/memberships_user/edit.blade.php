...
@section('content')
    <div class="container mt-4">
        <h1 class="mb-4">Edit User with Membership</h1>
        <form action="{{ route('membership-users.update', $user->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <!-- First Name -->
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="membership_start_date" id="date" class="network-info-input datepicker form-control" value="{{ old('membership_start_date', $user->membership_start_date ? $user->membership_start_date->format('Y-m-d') : '') }}">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="membership_end_date" id="date"  class="network-info-input datepicker form-control" value="{{ old('membership_end_date', $user->membership_end_date ? $user->membership_end_date->format('Y-m-d') : '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="form-check me-3">
                                <input type="radio" id="status_active" name="status" value="1" class="form-check-input" {{ old('status', $user->status) == 1 ? 'checked' : '' }} required>
                                <label for="status_active" class="form-check-label">Active</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" id="status_inactive" name="status" value="0" class="form-check-input" {{ old('status', $user->status) == 0 ? 'checked' : '' }} required>
