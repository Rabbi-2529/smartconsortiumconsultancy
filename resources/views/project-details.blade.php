...
<!-- Mirrored from devsaidul.com/html3/new/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 03:57:10 GMT -->
<head>
  <meta charset="UTF-8">
      ...
      <div class="container z-3 position-relative">
        <div class="row">
          <div class="col-12">
            <div class="row">
              <div class="col-lg-4">
                <div class="img overlay-anim zoom-effect overflow-hidden">
                  <img src="assets/images/project-details/img-1.png" alt="">
                </div>
              </div>
              <div class="col-lg-8">
                <div class="img overlay-anim zoom-effect overflow-hidden">
                  <img src="assets/images/project-details/img-2.png" alt="">
                </div>
              </div>
            </div>
            ...
            <div class="project-details-info">
              ...
              <p>Website:
                <span>www.domain visi.com</span>
              </p>
            </div>
            <hr>
            <p>As the infamous truck driver shortage continues like an endless long haul, companies with products to
              move are nervously eyeing the future. The expansion of e-commerce and the increasing consumer demands only
              make the driver shortage much more imperative for shippers to solve. Unfortunately, there’s another
              shortage in the supply chain that isn’t snagging as many headlines but will affect your supply chain just
              as much. Companies that rely on air freight may want to buckle up: there’s structural turbulence at 20,000
              feet in the form of a pilot shortage.As the infamous truck driver shortage continues like an endless long
              haul, companies with products to move are nervously eyeing the future. The expansion of e-commerce and the
              increasing consumer demands only make the driver shortage much more imperative for shippers to solve.
              Unfortunately, there’s anoth</p>
            <h2>The Results of Our Project</h2>
            <p>Lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia
              ...
              enim var sed efficitur turpis gilla sed sit amet finibus eros. Lorem Ipsum sed efficitur turpis gilla sed
              sed efficitur turpis gilla sed </p>
            <div class="service-2">
              <div class=" overlay-anim zoom-effect overflow-hidden">
                <img src="assets/images/blog/popular-post-3.png" alt="">
              </div>
              <div class="content">
                <h1>Digital Marketing Around the World</h1>
                <ul>
                  <li>
                    <span>
                      <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                          d="M8.74234 21.2619C8.42826 21.2619 8.11418 21.1417 7.87491 20.9024L0.359911 13.3872C-0.11997 12.9075 -0.11997 12.132 0.359911 11.6523C0.839568 11.1727 1.61488 11.1727 2.09476 11.6523L8.74234 18.2999L22.9054 4.13709C23.385 3.65743 24.1603 3.65743 24.6402 4.13709C25.1199 4.61697 25.1199 5.39228 24.6402 5.87216L9.60999 20.9024C9.37073 21.1417 9.05642 21.2619 8.74234 21.2619Z"
                          fill="#D90A2C"></path>
                      </svg>
                    </span>
              ...
              <div class="col-lg-6">
                <div class="d-flex align-items-center justify-content-start gap-3">
                  ...
                  <ul class="social-link">
                    <li>
                      <a href="#" data-abc="true"><i class="fa-brands fa-facebook-f"></i></a>
                    </li>
                    <li>
                      <a href="#" data-abc="true"><i class="fa-brands fa-instagram"></i></a>
                    </li>
                    <li>
                      <a href="#" data-abc="true"><i class="fa-brands fa-twitter"></i></a>
                    </li>
                    <li>
                      <a href="#" data-abc="true"><i class="fa-brands fa-linkedin-in"></i></a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <hr>
            <div class="row pagination-arrow">
...
<!-- Mirrored from devsaidul.com/html3/new/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 03:57:11 GMT -->
</html>