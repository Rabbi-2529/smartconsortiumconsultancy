...
<!-- Mirrored from devsaidul.com/html3/new/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 03:57:14 GMT -->
<head>
  <meta charset="UTF-8">
  ...
  <div class="main">
          ...
          <div class="overlay">
            <div class="container">
              ...
              <div class="banner-section">
                <h1 class="heading split-collab">FAQ Page</h1>
                <p class="description">
      ...
      <div class="container position-relative z-3">
        <div class="row align-items-center">
          <div class="col-lg-6">
            ...
            <h1 class="heading skew-up">
              Frequently Asked <br>
              Questions
            </h1>
            <p class="description">
              Sed ut perspiciatis unde omniste natus voluptatem accusantiume
              rem aperia eaque quae abillo inventore veritatis quasi
          ...
          <div class="col-lg-6">
            <div class="accordion" id="accordionExampleFaq">
              <div class="accordion-item">
                ...
                <div id="collapseOneFaq" class="accordion-collapse collapse show" data-bs-parent="#accordionExampleFaq">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseTwoFaq" aria-expanded="false" aria-controls="collapseTwoFaq">
                    Adipiscing elit, sed do eiusmod tempor?
                  </button>
                </h2>
                <div id="collapseTwoFaq" class="accordion-collapse collapse" data-bs-parent="#accordionExampleFaq">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseThreeFaq" aria-expanded="false" aria-controls="collapseThreeFaq">
                    Quis nostrud exercitation ullamco?
                  </button>
                </h2>
                <div id="collapseThreeFaq" class="accordion-collapse collapse" data-bs-parent="#accordionExampleFaq">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseFourFaq" aria-expanded="false" aria-controls="collapseFourFaq">
                    What trophy do we want on our mantle?
                  </button>
                </h2>
                <div id="collapseFourFaq" class="accordion-collapse collapse" data-bs-parent="#accordionExampleFaq">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
              ...
              <div class="accordion-item">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collapseFiveFaq" aria-expanded="false" aria-controls="collapseFiveFaq">
                    How do I start an app business?
                  </button>
                </h2>
                <div id="collapseFiveFaq" class="accordion-collapse collapse" data-bs-parent="#accordionExampleFaq">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
    ...
    <section class="build-website">
      ...
      <div class="row position-relative z-1">
        <div class="col-12">
          <h1 class="skew-up-2">Build Website Without Any Coding</h1>
          <a href="#">Our Service</a>
          <div class="client-logo swiper mySwiper-brand-1">
            <div class="swiper-wrapper">
              <div class="swiper-slide client-logo-item">
                <img src="assets/images/home-2/build-website-client-logo-1.png" alt="brand">
              </div>
              <div class="swiper-slide client-logo-item">
                <img src="assets/images/home-2/build-website-client-logo-2.png" alt="brand">
              </div>
              <div class="swiper-slide client-logo-item">
                <img src="assets/images/home-2/build-website-client-logo-3.png" alt="brand">
              </div>
              <div class="swiper-slide client-logo-item">
                <img src="assets/images/home-2/build-website-client-logo-4.png" alt="brand">
              </div>
              <div class="swiper-slide client-logo-item">
                <img src="assets/images/home-2/build-website-client-logo-5.png" alt="brand">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="accordion" id="accordionExampleOne">
              ...
              <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExampleThree">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
              ...
              <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExampleFour">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
              ...
              <div class="accordion-item">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExampleFive">
                  <div class="accordion-body">
                    We approached WiaTech with complex project Designing a
                    website can involve various suchas layout, graphics,
                    content, and experience
